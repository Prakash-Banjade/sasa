...
const AboutMain = () => {
  return (
    <div className="about-container container">
      <div className="left-content dflex dflex-column gap-1">
        ...
        <Button sx={{width: 'fit-content', padding: 0, borderBottom: '2px solid currentcolor', borderRadius: '0'}}>Get In Touch</Button>
      </div>

      <div className="right-content dflex dflex-column gap-1">
        <h4 className="dflex"><span></span>Who We Are</h4>
        <h2 className="big-heading" style={{ maxWidth: '28ch'}}>We Are Most Advanced Agency In The Market</h2>
        <p>
        ...
        <div className="ticks">
          <CheckCircleRoundedIcon color="primary" /> <span>Excellence In Everyting</span>
        </div>
