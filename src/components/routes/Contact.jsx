...
const Contact = () => {
  ...
  const inputStyle = useMemo(()=>{
    return {
      background: dark ? "var(--primary-background-dark1)" : "#ddd",
        ...
        <div className="right-content">
          ...
          >
            <div className="name-field">
              <label
                style={{ color: dark ? "var(--white)" : "var(--text-color)" }}
                htmlFor="name"
              >
                Your Name
            ...
            >
              <Button
                sx={{ padding: "8px 15px", width: "100%", fontSize: "1.2rem" }}
                variant="contained"
              >
                Send
              </Button>
