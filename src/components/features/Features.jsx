...
const Features = () => {
  ...
  return (
    <div className="features-container container dflex dflex-column gap-2 dflex-wrap">
      <h2 className="heading" data-aos="fade-up">Our Key Features</h2>
      <div className="features-cards dflex wrap">
        <div className="feature dflex dflex-column" data-aos="slide-left" data-aos-offset="170">
        ...
        <div className="feature dflex dflex-column" data-aos="slide-right" data-aos-offset="170">
